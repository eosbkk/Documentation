...
Therefore, we can avoid the concentration of large stakeholders taking control by adopting a method of concentration relative to staked weight  the premise of the stability of the system, on the premise of the stability of the system. So the question remains: is there an ideal voting solution?
